...
<body>
  ...
  <div class="container">
  <div id="emp" class="page-header">
    <h1>Employer Login</h1>
  </div>


       <form class="form-horizontal" action="<?php echo base_url('index.php/home/epro') ?>">

       <!-- Button -->
       <div class="form-group" >
         <div class="col-md-4 control-label">
           <a href="<?php echo base_url('index.php/home/signupemp') ?>" id="signup" name="singlebutton" class="btn btn-primary">Sign Up</a>
         </div>
       </div>
       ...
       <div class="form-group" id="login">
         ...
         <div class="col-md-4">
            <button id="login" name="singlebutton" class="btn btn-primary">Login</button>
         </div>
       </div>
